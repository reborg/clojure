        ...
        public Expr parse(C context, Object frm) {
            ...
            if (maybeField && !(((Symbol) RT.third(form)).name.charAt(0) == '-')) {
                ...
                if (c != null)
                    ...
                    maybeField = Reflector.getMethods(instance.getJavaClass(), 0, Compiler.munge(sym.name), false).size() == 0;
            }
            ...
            if (maybeField)    //field
            {
                ...
                if (c != null) {
                    ...
                    return new InstanceFieldExpr(line, column, instance, Compiler.munge(sym.name), tag, (((Symbol) RT.third(form)).name.charAt(0) == '-'));
            } else {
