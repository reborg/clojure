    ...
    public void emitStatics(ClassVisitor cv) {
        if (this.isDeftype()) {
            ...
            if (this.isDeftype() && this.fields.count() > this.hintedFields.count()) {
                ...
                MethodVisitor mv = cv.visitMethod(Opcodes.ACC_PUBLIC + Opcodes.ACC_STATIC, "create", "(Lclojure/lang/IPersistentMap;)L" + className + ";", null, null);
                mv.visitCode();
                ...
                for (ISeq s = RT.seq(hintedFields); s != null; s = s.next(), i++) {
                    ...
                    mv.visitMethodInsn(Opcodes.INVOKESTATIC, "clojure/lang/Keyword", "intern", "(Ljava/lang/String;)Lclojure/lang/Keyword;");
                    mv.visitInsn(Opcodes.ACONST_NULL);
                    mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, "clojure/lang/IPersistentMap", "valAt", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
                    if (k.isPrimitive()) {
                    ...
                    mv.visitLdcInsn(bName);
                    mv.visitMethodInsn(Opcodes.INVOKESTATIC, "clojure/lang/Keyword", "intern", "(Ljava/lang/String;)Lclojure/lang/Keyword;");
                    mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, "clojure/lang/IPersistentMap", "without", "(Ljava/lang/Object;)Lclojure/lang/IPersistentMap;");
                ...
                mv.visitInsn(Opcodes.ACONST_NULL);
                mv.visitVarInsn(Opcodes.ALOAD, 0);
                mv.visitMethodInsn(Opcodes.INVOKESTATIC, "clojure/lang/RT", "seqOrElse", "(Ljava/lang/Object;)Ljava/lang/Object;");
